...
[
  ...
  highest-share-overall;; Highest number of infected people
]
...
to run-all
  ...
  repeat 20 [
    ...
    set r0-list lput r0 r0-list
    set hso-list lput highest-share-overall hso-list
    set ticks-list lput ticks ticks-list
    set csoI-list lput (((count turtles with [ cured? ] + count turtles with [ infected? ]) / initial-people) * 100) csoI-list
  ]

  print(word "   HSO ")
  print(hso-list)
  print(word "Med:  " (median hso-list) word "   sd: " (standard-deviation hso-list))
  print(word "   HOURS/TICKS ")
  print(ticks-list)
  print(word "Med:  " (median ticks-list) word "   sd: " (standard-deviation ticks-list))
  print(word "   CSOI ")
  print(csoI-list)
  print(word "Med:  " (median csoI-list) word "   sd: " (standard-deviation csoI-list))
  print(word "   RO ")
  print(r0-list)
  print(word "Med:  " (median r0-list) word "   sd: " (standard-deviation r0-list))
...
to go
  if ( count turtles with [ infected? ] > highest-share-overall)[
    set highest-share-overall (count turtles with [ infected? ])
  ]
...
to infect  ;; turtle procedure
    ...
    with [ not infected? and not cured? and not inoculated? and not ambulance? ]
...
to calculate-r0
  ...
  let susceptible-t (count turtles with [ not ambulance? ] - (count turtles with [ infected? ]) - (count turtles with [ cured? ]))  ;; Number of susceptibles now
  ...
  [
    ...
    set r0 (ln (s0 / susceptible-t) / (count turtles with [ not ambulance? ] - susceptible-t))
    set r0 r0 * s0 ]
end
...
"" ""
PENS
"Infected" 1.0 0 -2674135 true "" "plot (count turtles with [ infected? ] / (count turtles with [ infected? ] + count turtles with [ not infected? ]))"
"Not Infected" 1.0 0 -10899396 true "" "plot (count turtles with [ not infected? ] / (count turtles with [ infected? ] + count turtles with [ not infected? ]))"
...
false
0
Circle -1 true false 172 0 84
Circle -13791810 true false 187 15 54
Polygon -7500403 true true 294 176 294 161 294 146 294 131 294 116 287 86 279 71 262 52 234 41 144 41 84 41 9 41 9 161 9 221 294 221 294 191
Circle -16777216 true false 195 195 60
Circle -16777216 true false 45 195 60
Circle -7500403 true true 62 210 28
Circle -7500403 true true 210 210 28
Rectangle -16777216 true false 26 60 120 120
Rectangle -16777216 true false 135 60 195 120
Polygon -16777216 true false 210 60 210 120 270 120 270 105 265 86 257 72 240 60 210 60
Rectangle -7500403 true true 135 130 194 207
Rectangle -13345367 true false 10 160 273 176
Rectangle -2674135 true false 9 148 272 164
