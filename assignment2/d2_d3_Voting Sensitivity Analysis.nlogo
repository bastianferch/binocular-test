...
to run-all
  ...
  repeat 20 [
    setup
    go
    set results-list lput ((count patches with [ pcolor = green ] )/((count patches with [ pcolor = green ] ) + (count patches with [ pcolor = blue ] ) ) ) results-list
  ]
  let average-result mean results-list
  let sd-result standard-deviation results-list
  let median-result median results-list
  print(word "mean: "  (average-result * 100))
  print(word "median: " (median-result * 100))
  print(word "sd: " (sd-result * 100))
  print(word " ")
end
...
163
353
share of green patches
((count patches with [ pcolor = green ] )/((count patches with [ pcolor = green ] ) + (count patches with [ pcolor = blue ] ) ) )
2
1
11
